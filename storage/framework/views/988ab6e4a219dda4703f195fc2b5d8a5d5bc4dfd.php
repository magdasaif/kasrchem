                        ...
                        <!--############################ model for delete #################################-->
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <form action="<?php echo e(route('release.destroy',$release->id)); ?>"  method="post">
                                    ...
                                    <input type="hidden" name="deleted_image" value="<?php echo e($release->image); ?>">
                                    <input type="hidden" name="deleted_file" value="<?php echo e($release->file); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\final\backend\resources\views\pages\Release\Show.blade.php ENDPATH**/ ?>