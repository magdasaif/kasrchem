...
} elseif ($_instance->childHasBeenRendered('mielEsj')) {
    $componentId = $_instance->getRenderedChildComponentId('mielEsj');
    $componentTag = $_instance->getRenderedChildComponentTagName('mielEsj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mielEsj');
} else {
    $response = \Livewire\Livewire::mount('productlivewire', []);
    $html = $response->html();
    $_instance->logRenderedChild('mielEsj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
