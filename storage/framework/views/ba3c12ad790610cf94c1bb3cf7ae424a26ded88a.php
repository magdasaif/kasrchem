...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
            <form method="POST" action="<?php echo e(url('add_products_files',$product_id)); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row">
            <?php $__currentLoopData = $Product_files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
                 <div class="col">
                 ...
                 <div class="modal modal-danger fade" id="delete<?php echo e($file->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                ...
                                <form action="<?php echo e(url('delete_products_files/'.$file->id)); ?>"  method="POST">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eradco-backend\final\backend\resources\views\pages\products\files.blade.php ENDPATH**/ ?>