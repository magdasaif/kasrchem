    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            ...
            <!--#############################################################-->
                    ...
                    <button type="button"   class="btn btn-success"><a href="<?php echo e(URL('site_section/create')); ?>" target="_blank"> اضافة قسم جديد</a>
                        </button>
                     <br><br>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $site_section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td> <button type="button" class="btn btn-info" ><a href="<?php echo e(route('site_section.edit',$section->id)); ?>"  target="_blank"> تعديل</a></button>
                             </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eradco-backend\final\backend\resources\views\pages\Sitesection\Sitesection.blade.php ENDPATH**/ ?>