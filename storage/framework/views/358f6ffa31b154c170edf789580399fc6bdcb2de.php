...
<div>
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <form method="POST"  action="<?php echo e(route('release.update',$release->id)); ?>" enctype="multipart/form-data">
              ...
              <input type="hidden" name="release_id"  value="<?php echo e($release->id); ?>">
                ...
                <select   class="form-control main_category" id="main_category_id" name="main_category" required>
                 <option value="0" disabled="true" >اختر التصنيف الرئيسى</option> 
                    <option value="<?php echo e($release->relation_with_main_category->id); ?>" selected="true"><?php echo e($release->relation_with_main_category->subname_ar); ?></option>
                   <?php 
        ...
        <div id="all" style="background-color: #e8f2f9;border-radius: 23px;width: 95%; margin: auto;padding: 20px;">    
            <div class="form-group"  id="sub2_div" style="display:block" >    
                    ...
                    <option value="<?php echo e($release->relation_with_sub2_category->id); ?>" selected="true"><?php echo e($release->relation_with_sub2_category->subname2_ar); ?></option>
                    <?php 
             ...
             <div class="form-group"  id="sub3_div" style="display:block" >
                <label>النوع</label>
                 ...
                 <option value="0" disabled="true" >اختر النوع </option>
                    <option value="<?php echo e($release->relation_with_sub3_category->id); ?>" selected="true"><?php echo e($release->relation_with_sub3_category->subname_ar); ?></option>
                    <?php 
                ...
                <label>النوع الفرعى</label>
                    ...
                    <option value="<?php echo e($release->relation_with_sub4_category->id); ?>" selected="true"><?php echo e($release->relation_with_sub4_category->subname_ar); ?></option>
                    <?php 
               ...
               <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title_ar" aria-describedby="title_ar" placeholder="ادخل عنوان الفيديو" name="title_ar" value="<?php echo e($release->title_ar); ?>" required>
...
unset($__errorArgs, $__bag); ?>
               ...
               <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title_en" aria-describedby="title_en" placeholder="ادخل اسم النشرة بالانجليزية" name="title_en"  value="<?php echo e($release->title_en); ?>" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eradco-backend\final\backend\resources\views/pages/release/edit.blade.php ENDPATH**/ ?>