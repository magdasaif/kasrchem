              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="btn btn-sm bbtn" >
                        <a href="{{route('categories4_new.index')}}" class="aa"> <li class="fas fa-cubes" ><span>  قائمة الانواع الفرعيه </span></li></a>
                    </button>
                </div>
              </div>
 <!--#############################################################-->
...
<div class="form-group">
   ...
   <!----------------------------------------------------->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name" name="subname_en" value="{{$sub4->subname_en}}" required onkeypress="return CheckEnglishCharactersOnly(event);" pattern="^(?=.*[a-zA-Z\s])[a-zA-Z0-9\s]+$" oninvalid="this.setCustomValidity('يجب ان يكون اسم النوع الفرعى باللغة الانجليزية وايضا لا يكون ارقام فقط')"  oninput="this.setCustomValidity('')">
