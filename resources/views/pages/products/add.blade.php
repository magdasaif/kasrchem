                    ...
                    <select class="form-control" name="supplier_id[]"  multiple required>
                        ...
                        ?>
                            ...
                            @if(count($supplier->childs))
                                @include('pages.products.manageChild',['childs' => $supplier->childs,'margin'=>$margin+30,'color'=>$color,'size'=>$size-1,'type'=>$type,'number'=>$number])
                            @endif
                        @endforeach
                    </select>
                </div>
