 ...
 <div class="modal-body"  >
   <form method="POST"  action="{{route('photo_gallery.update',encrypt($photo_gallery->id))}}" enctype="multipart/form-data">
           ...
           <!----------------------------------------------------->
              ...
              <!----------------------------------------------------->
                    @if(($photo_gallery->getFirstMediaUrl('gallery','edit')))
                        <center><img id="previewImg"src="{{$photo_gallery->getFirstMediaUrl('gallery','edit')}}" class="uploaded-img"> </center>
                        <input type="hidden" name="media_url" value="{{$photo_gallery->getFirstMediaUrl('gallery')}}">
                    @else
