              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                   ...
                   <button type="button" class="btn btn-sm" style=" background-color: #343a40;">
                        <a href="{{route('branches.create')}}" style="color: #fff; !important"> <li class="fa fa-plus-square" ><span> اضافة  </span></li></a>
                        </button>
            ...
            <!--#############################################################-->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('branches/'.$branche ->id.'/edit/')}}"  title="تعديل"><i class="fa fa-edit blue"></i></a>
                                /
                                <a href="#"  title="حذف" data-catid="{{$branche->id}}" data-toggle="modal" data-target="#delete{{$branche->id}}"> <i class="fa fa-trash red"></i></a>
							</td>
                        </tr>
