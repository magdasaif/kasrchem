    ...
    <div class="container-fluid">
        ...
        @include('layouts.messages')
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                   ...
                   <button type="button" class="btn btn-sm bbtn">
                        <a href="{{route('new_supplier.create')}}" class="aa"> <li class="fa fa-plus-square" ><span> اضافه </span></li></a>
                        </button>
            ...
            <div class="card-body table-responsive p-0">
                ...
                <input type="hidden" name="hidden_blade" id="hidden_model" value="supplier" />
                  ...
                  <thead>
                    ...
                    <tbody>
                        <!--=======================body  ============================-->
                            ...
                            @include('pages.new_supplier.paginate_new_supplier')
                            <!--========================================================-->
